...
namespace api.Migrations
{
    ...
    [Migration("20241202165928_UpdatePrimaryKeysToGuid")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "568231e8-c4e5-4385-80c6-daa22e5f159f",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "12fd1205-0f3b-4d37-8d8e-67ce9f2781a5",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Models.Image", b =>
                {
                    b.HasOne("api.Models.Motorcycle", null)
                        .WithMany("Images")
                        .HasForeignKey("MotorcycleId");
                });
